...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/radio-beam-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/radio-beam-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install radio-beam
```
...
It is possible to list all of the versions of `radio-beam` available on your platform:
...
```
pixi search radio-beam --channel conda-forge
```
